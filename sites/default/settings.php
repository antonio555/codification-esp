 ...
 *     CONFIG_SYNC_DIRECTORY => '/directory/outside/webroot','/sites/codification2.0.dd/files/config_acqTmp-2018-01-11T11.58.21-5844',
 *   );
 * @endcode
 */
$config_directories = array(
	CONFIG_SYNC_DIRECTORY => '/drupal-8.4.4/config/sync',
	);
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_codification2_0_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_codification2_0_dd.inc';
}
// </DDSETTINGS>
